...
<?php
    ...
    <center>
        <div class="table-responsive" data-aos="fade-up"  data-aos-once= "true">
            <table class="table table-hover table-striped"  style="width: 65%;  font-size: 23px;" >
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="student-attendence.php?t_id=<?php echo $data['t_id']; ?>"><input type='submit' style="width: 50%;" value='View More' id='attendence'></a></td>
                    </tr>	
                    <?php
                        }
                    ?>
